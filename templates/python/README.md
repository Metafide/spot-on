# Metafide Spot Bot — Python CLI

A Python CLI bot for automatically placing positions in the Metafide Spot game.
...
Open `config.py` and set your real values:
...
Current Python version is configured for:
...
4. Once confirmed, use background mode:
